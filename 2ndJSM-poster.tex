...
%%% Authors %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
  \vspace{1em} \textcolor{metudark}{
   	K, Yurtseven*, K. Aytemiz, C. Kehribar, Ö. Nazlı, Z. Çırnaz, T, Yücel,\\ S. Sarikurt Malcioglu,  O.B. Malcioglu\\
	{\smaller *kaan.yurtseven@metu.edu.tr}
}
...
\headerbox{Second Quantum Revolution}{name=sqr,column=0,row=0}{
  \textbf{We’re in the midst of a new revolution in quantum physics.} The first revolution enabled inventions such as the laser and transistor, the basic building block of computers, when scientists knew the rules of quantum mechanics and built devices that followed those rules. The second quantum revolution is all about controlling individual quantum systems, such as charged molecules, to a greater extent than before, enabling even more powerful applications of quantum information theory. \\
    ...
    \centering
    \includegraphics[width=\linewidth]{Screenshot 2024-04-16 121033.png}
    \smaller{Liang, J. et al. Attosecond-resolved non-dipole photoionization dynamics. Nat. Photon. 18, 311–317 (2024). https://doi.org/10.1038/s41566-023-01349-z}
}
%%% Quantum Discord %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Quantum Discord}{name=qd,column=1,row=0}{
\textbf {A handy tool from Quantum information theory for understanding nC:}\\

 \begin{columns}
    \column{0.4\textwidth}
    \center{
    \includegraphics[width=1\linewidth]{Entropy-mutual-information-relative-entropy-relation-diagram.svg.png} }
...
\headerbox{Follow us in GitHub}{name=follow,column=0,below=CS,above=bottom}{
 \centering
    \includegraphics[height=8em]{TDLDEFA-QUN-github.png}

    
}
%%% Machine learning %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Error mitigation with Machine Learning}{name=ML,column=1,below=qd}{
